...
FROM @STAGEDW.PROD_S3/NETWORK/Kafka_Topics/gw_cdr_processed/2022/09/22/14/
...
-- [Connection info]
SNOWFLAKE_ACCOUNT = "ft32896.us-east-1"
SNOWFLAKE_USER = "AP_EDW_VCOST_DEV"
SNOWFLAKE_PASSWORD = "$#@FG56)~bnvc45Wd3%"
...
-- snf_snowflake_account_name = "ft32896.us-east-1"
-- snf_snowflake_user_name = "AP_EDW_VCOST_DEV"
-- snf_snowflake_password = "$#@FG56)~bnvc45Wd3%"
-- snf_snowflake_db = "EDW_DEV"
-- snf_snowflake_schema = "PUBLIC"
-- copyFile = -- 
...
-- >> https://stackoverflow.com/questions/27382009/aws-lambda-scheduled-tasks